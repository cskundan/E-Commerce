            ...
            <div className="flex flex-col justify-center items-center bg-gray-100">
              ...
              <div className="w-full flex gap-10 justify-between items-start px-7 max-w-2xl">
                ...
                <div className="flex flex-col items-center">
                  ...
                  />
                  <Label className="mt-4 cursor-pointer bg-pink-600 text-white w-34 px-4 py-2 rounded-lg hover:bg-pink-700">
                    Change Picture
                    <Input
                      type="file"
                      accept="image/*"
                ...
                <form
                  ...
                  className="space-y-4 shadow-lg p-5 rounded-lg bh-white"
                >
